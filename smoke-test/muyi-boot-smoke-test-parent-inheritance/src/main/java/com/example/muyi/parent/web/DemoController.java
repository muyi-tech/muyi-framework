...
import com.example.muyi.parent.constant.DemoErrorCode;
...
public class DemoController {
    ...
    /**
     * 业务异常本地化：抛出带占位符参数的业务异常，由异常处理模块按请求 Accept-Language
     * 解析错误码注册表中的多语言文案（zh-CN / en-US，未匹配语言回退默认 msg）。
     *
     * @return 不会正常返回
     */
    @GetMapping("/i18n-error")
    public ApiResult<String> i18nError() {
